...
function ListHebergement() {
    ...
    console.log(hebergements.prix)
    console.log(searchHebergementAdult)
    return (
        <Container>
            <Row>
                    ...
                    <div className="row g-0">
                      ...
                      <div className="col-md-8">
                        <div className="card-body">
                          ...
                          {`prix : ${((searchHebergementAdult*listHebergement.prix) + (searchHebergementChild*listHebergement.prix/2))} Dt `}
                             </p>
